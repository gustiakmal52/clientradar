...
class CustomUserAppScraper(BaseScraperAdapter):
    ...
    """
    def __init__(self, target_address: Optional[str] = None, api_key: Optional[str] = None):
        self.target_address = target_address
        self.api_key = api_key

    def set_target_address(self, address: str, api_key: Optional[str] = None):
    ...
    async def fetch_leads(self, keyword: str, location: Optional[str] = None, custom_endpoint: Optional[str] = None) -> List[ProspectLead]:
        ...
        try:
            ...
            async with httpx.AsyncClient(timeout=10.0) as client:
                ...
                res = await client.get(endpoint, params={"q": keyword, "location": location or ""}, headers=headers)
            ...
            raise RuntimeError("Sumber kustom gagal merespons atau mengirim data yang valid") from exc
